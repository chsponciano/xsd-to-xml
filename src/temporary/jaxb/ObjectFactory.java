 ...
 * generated in the temporary.jaxb package. 
...
public class ObjectFactory {
    ...
    private final static QName _CompNfse_QNAME = new QName("", "CompNfse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: temporary.jaxb
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "CompNfse")
